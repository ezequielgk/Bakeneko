...
pkgs.mkShell {
  ...
  shellHook = ''
    ...
    export LD_LIBRARY_PATH="${pkgs.stdenv.cc.cc.lib}/lib:${pkgs.sqlite.out}/lib:${pkgs.libGL}/lib:${pkgs.libglvnd}/lib:${pkgs.libepoxy}/lib''${LD_LIBRARY_PATH:+:$LD_LIBRARY_PATH}"
    echo ""
